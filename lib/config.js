...
nconf.init = function (configFile) {
    ...
    // 3) default config/config-yytang.yaml
    ...
    if (typeof configFile === 'undefined') {
        ...
        configFile = path.join(__dirname, '/../config/config-yytang.yaml');
        ...
        if (!fs.existsSync(configFile)){
            ...
            console.log('\x1b[31m', 'Created config-yytang.yaml. Update with your local settings and restart the app');
